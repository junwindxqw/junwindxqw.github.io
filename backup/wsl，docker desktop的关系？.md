...
* Ubuntu-24.04      Running         2
  docker-desktop    Running         2      // 这台就是跑dockerd服务的Linux系统
```
...
- 也就是启用了这个后，其它的wsl系统中，也可以直接使用docker命令了，不过实际的dockerd服务，还是在wsl的docker-desktop中。https://www.doubao.com/thread/a7b705fff061e
